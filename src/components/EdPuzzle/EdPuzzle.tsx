...
function EdPuzzle() {
  ...
  const handleUnlockTimelineClick = async () => {
    chrome.runtime.sendMessage(Message(MessageAction.EdpuzzleOverlayUnlockTimeline, {}));
  };

  const handleSubmitAnswersClick = async () => {
    chrome.runtime.sendMessage(Message(MessageAction.EdpuzzleFinishAllMultipleChoice, {}));
  };
